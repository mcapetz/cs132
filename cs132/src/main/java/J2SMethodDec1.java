...
public class J2SMethodDec1 extends GJNoArguDepthFirst<String> implements GJNoArguVisitor<String>{
...
public Boolean in_ret = false;
   ...
   public J2SMethodDec1(SymbolTable symbol_table, NameGenerator name_generator) {
...
//    System.out.println("I GOT HERE");
    ...
    //   System.out.println("methods: " + sym.method_array);
      ...
      // System.errprintln("name_w: " + name_w);
      // System.errprintln("t: " + name_w);
