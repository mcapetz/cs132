...
public class J2SMethodDec2 extends GJNoArguDepthFirst<String> implements GJNoArguVisitor<String>{
...
public Boolean in_ret = false;
   ...
   public J2SMethodDec2(SymbolTable symbol_table, NameGenerator name_generator) {
   ...
   public String visit(MethodDeclaration n) { // in this visitor, we handle the parameters
    //   System.out.println("got to method dec!");
      ...
      System.err.println("in method dec");
    ...
    //   System.out.println("param names: " + sym.param_names);
      if(sym.parent_table.name == null) {
         ...
         System.err.println(sym.parent_table.name);
         program_string += "func " + curr_sym.name + name_generator.capitalizeFirstLetter(method_name) + "(this";
...
// w5 is Element
      ...
      //   temp_params = temp_array;
        ...
        if(D == "this") {
            ...
            // System.errprintln("I AM HEREEEEE: " + alloc_w);
            ...
            // System.errprintln("try prev: " + prev_alloc_w);
               ...
               if(prev_alloc_w == "temp_e" || temp_params.contains(D)){
                  ...
                  if(expr_v != null) {
                     // System.errprintln("adding this: " + ret_v + " = call " + name_holder + "(" + alloc_w + " " + expr_string + ")\n");
                        program_string += ret_v + " = call " + name_holder + "(" + alloc_w + " " + expr_string + ")\n"; // this is the problem
                  }
                  else {
                     // System.errprintln("adding this: " + ret_v + " = call " + name_holder + "(" + alloc_w + ")\n");
