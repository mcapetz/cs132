 ...
 */
public class J2SVisitor21 extends GJNoArguDepthFirst<String> implements GJNoArguVisitor<String>{
...
//    int name_count = 0;
   ...
   public J2SVisitor21(SymbolTable symbol_table, NameGenerator name_generator, Map<String, StringPair> method_ret_label) {
