...
public class J2SMethodDecBAD extends GJNoArguDepthFirst<String> implements GJNoArguVisitor<String>{
...
public Boolean in_message_send = false;
   ...
   public J2SMethodDecBAD(SymbolTable symbol_table, NameGenerator name_generator) {
   ...
   public Map<String, String> get_t_to_w_table() {
      return type_to_w;
   }
   ...
   public String visit(ArrayAssignmentStatement n) {
      ...
      // System.err.println("ERROR: name_comp: " + name_comp);
...
no_bracket = false;
   ...
   public String visit(MessageSend n) { // for the message send, look at the expr list
        System.err.println("in message send-----------");
        in_message_send = true;
        no_bracket = true;
        String D = n.f0.accept(this); // maybe this is the result of this
        no_bracket = false;
...
// w5 is Element
      ...
      //   System.err.println("i got here 2");
      //   System.err.println("try: " + try_to_get_alloc_w);
        if(try_to_get_alloc_w != null) {
         System.err.println("I got here!");
         ...
         // System.err.println("alloc_W: " + alloc_w);
        }
      ...
      //   System.out.println("index: " + root_table.getType(sym4.parent_table.name).method_array.indexOf(method_name));
        ...
        Integer index_of_method = root_table.getType(sym4.parent_table.name).method_array.indexOf(method_name);
      ...
      // System.err.println("index: " + index_of_method);
      ...
      //   System.err.println("expr str: " + expr_string);
      ...
      //   System.err.println("message send returning: " + ret_v);
      //   program_string += "temp = " + ret_v + "\n";
      //   use_temp = true;
      //   System.err.println("temp_type: " + D);
      //   temp_type = D;
      //   return "temp";

         // there is an issue when we are getting ret_v as a primary expression
         use_temp = true;
         ...
         if((symbol_table.getType(D)) != null) {
            ...
            // System.err.println("D type: " + type_of_D);
            temp_type = type_of_D;
         }
   ...
   public String visit(PrimaryExpression n) { 
      String t0 =  n.f0.accept(this);
      // System.err.println("primary expr: " + t0);
      return t0;
   }
   ...
   public String visit(Identifier n) { 
      ...
      // System.err.println("identifier t0: " + t0);
