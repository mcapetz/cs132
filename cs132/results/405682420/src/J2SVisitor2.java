 ...
 */
public class J2SVisitor2 extends GJNoArguDepthFirst<String> implements GJNoArguVisitor<String>{
...
//    int name_count = 0;
   ...
   public J2SVisitor2(SymbolTable symbol_table, NameGenerator name_generator, Map<String, StringPair> method_ret_label) {
      ...
      //   System.out.println(sym3.method_array.indexOf(method_name));
        ...
        if(index_of_method == -1) {
            ...
            if(index_of_method == -1) {
               ...
               // index_of_method += parent_sym.method_array.size();
            }
         }
       
      //   System.out.println("here");
         System.err.println("look: " + index_of_method);
...
//    System.out.println("I GOT HERE");
     ...
     if(sym == null) {
      ...
      do_inheritance = false;
      System.err.println(name_w);
      System.err.println("vis2 alloc expr returning: " + t);
      if(in_ret) {
