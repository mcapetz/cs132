...
public class J2SMethodDec3 extends GJNoArguDepthFirst<String> implements GJNoArguVisitor<String>{
...
public List<String> curr_params_list = null;
   ...
   public J2SMethodDec3(SymbolTable symbol_table, NameGenerator name_generator) {
   ...
   public String visit(MethodDeclaration n) { // in this visitor, we handle the parameters
    ...
    //   System.out.println("returning: " + ret);
      ...
      System.err.println("mem vars2: " + curr_class_sym.member_vars);

      if(curr_class_sym.member_vars.contains(ret)) {
         String name_ret = name_generator.generateName();
         Integer idx = curr_class_sym.member_vars.indexOf(ret);
      ...
      //   System.out.println("index: " + root_table.getType(sym4.parent_table.name).method_array.indexOf(method_name));
        ...
        if(index_of_method == -1) {
         System.err.println("HELP HERE");
            ...
            System.err.println("index of met try one: " + index_of_method);
   ...
   public String visit(Identifier n) { 
      ...
      if(curr_sym != null) {
         ...
         // System.out.println("member: " + root_table.getType(curr_sym.curr_table.parent_name).member_vars);
            ...
            // check if it is a current mem var
            System.err.println("HEY:" + curr_class_sym.member_vars);
            if(curr_class_sym.member_vars.contains(t0)) {
               Integer idx = curr_class_sym.member_vars.indexOf(t0);
               String name_ret = name_generator.generateName();
               program_string += name_ret + " = [this" + " + " + 4 * (idx + 1) + "]\n";
               return name_ret;
